"""aggiunto database con statistiche

Revision ID: c92d701ae77a
Revises: 
Create Date: 2025-12-27 14:35:58.542164
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_pathology'], ['pathology.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_pathology', 'id_parameter', 'control_number')
    )
